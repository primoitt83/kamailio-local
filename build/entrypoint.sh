...
## rtpengine
sed -i "s/KAMAILIO_IP_INTERNO/$KAMAILIO_IP_INTERNO/g" /etc/rtpengine/rtpengine.conf
sed -i "s/KAMAILIO_IP_EXTERNO/$KAMAILIO_IP_EXTERNO/g" /etc/rtpengine/rtpengine.conf
